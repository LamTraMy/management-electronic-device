...
class _DropdownMenuItemButtonState<T>
  ...
  void _handleOnTap() {
    final DropdownMenuItem1<T> dropdownMenuItem =
...
class _MenuItem<T> extends SingleChildRenderObjectWidget {
  ...
  final DropdownMenuItem1<T>? item;
...
class DropdownMenuItem1<T> extends _DropdownMenuItemContainer {
  const DropdownMenuItem1({
    super.key,
    this.onTap,
    this.value,
    this.enabled = true,
...
class CustomDropDownButton<T> extends StatefulWidget {
  CustomDropDownButton({
    ...
    this.borderRadius,
          ...
          items == null ||
              items.isEmpty ||
              value == null ||
              items.where((DropdownMenuItem1<T> item) {
  ...
  final List<DropdownMenuItem1<T>>? items;
...
class _CustomDropDownButtonState<T> extends State<CustomDropDownButton<T>>
  ...
  void _updateSelectedIndex() {
    ...
    assert(
      widget.items!
              .where((DropdownMenuItem1<T> item) => item.value == widget.value)
              .length ==
          1,
    );
